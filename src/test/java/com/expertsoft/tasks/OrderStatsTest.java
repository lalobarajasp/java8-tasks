...
public class OrderStatsTest {
    ...
    //@BeforeClass annotated method will be run before the first test method
    ...
    //TestNG annotations are defined before every method in the test code. In case any method is
    //not prefixed with annotations, it will be ignored and not be executed as part of the test code.
    @Test
